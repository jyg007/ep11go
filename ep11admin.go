...
func main() {
	...
	resp , err:= ep11.AdminCommand(target,16, C.XCP_ADM_DOM_ADMIN_LOGIN,cert1Bytes,nil)        
        if err != nil {    
            fmt.Println(err)
        }
...
// **********************************************************************************************************************
	...
	resp , err = ep11.AdminCommand(target,16, C.XCP_ADM_DOM_ADMIN_LOGOUT,ski1Bytes,nil)        
        if err != nil {    
            fmt.Println(err)
        }
	printSKIs(resp.Response)
...
// QUERY ATTRIBUTES
// **********************************************************************************************************************
	resp , err = ep11.AdminQuery(target,19, C.XCP_ADMQ_DOM_ATTRS)        
        if err != nil {    
            fmt.Println(err)
        }
	fmt.Println()
...
// **********************************************************************************************************************
	...
	resp , err = ep11.AdminCommand(target,16, C.XCP_ADM_DOM_SET_ATTR,attrsBytes,[][]byte{privadmin1Bytes})        
        if err != nil {    
            fmt.Println(err)
        }
	PrintAdminAttributes(resp.Response)
...
// **********************************************************************************************************************
	resp , err = ep11.AdminCommand(target,16, C.XCP_ADM_GEN_WK,nil,[][]byte{privadmin1Bytes})        
        if err != nil {    
            fmt.Println(err)
        } else {
		fmt.Printf("New MEK verification pattern         %x\n", resp.Response)
   	}
	resp , err = ep11.AdminCommand(target,16, C.XCP_ADM_GEN_WK,nil,[][]byte{privadmin1Bytes})        
        if err != nil {    
            fmt.Println(err)
...
// ZERORIZE DOMAIN
// **********************************************************************************************************************
	resp , err = ep11.AdminCommand(target,16, C.XCP_ADM_DOM_ZEROIZE,nil,[][]byte{privadmin1Bytes})        
        if err != nil {    
            fmt.Println(err)
        } else {
	 fmt.Printf("Domain zerofied\n")
	}
...
// LIST ADMIN SKIs
// **********************************************************************************************************************
	resp , err= ep11.AdminQuery(target,16, C.XCP_ADMQ_DOMADMIN)        
        if err != nil {    
            fmt.Println(err)
        }
	fmt.Println()
...
// SCAN DOMAINS
// **********************************************************************************************************************
for domain := uint32(0); domain <= 40; domain++ {
    fmt.Printf("\n--- Domain %d ---\n", domain)
...
// **********************************************************************************************************************
	resp , err = ep11.AdminQuery(target,19, C.XCP_ADMQ_ATTRS)        
        if err != nil {    
            fmt.Println(err)
        }
	fmt.Println()
...
// SCAN MEK MKVPS
// **********************************************************************************************************************
	resp , err = ep11.AdminQuery(target,19, C.XCP_ADMQ_WK_ORIGINS)        
        if err != nil {    
            fmt.Println(err)
        }
	fmt.Printf("\nKey Parts pattern         %x\n", resp.Response)
