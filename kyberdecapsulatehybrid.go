...
func main() {
    ...
    checksum , err := hex.DecodeString(os.Args[3])
	...
	Params := ep11.KyberParams{Version:C.XCP_KYBER_KEM_VERSION , Mode: C.CK_IBM_KEM_DECAPSULATE , Kdf: C.CKD_IBM_HYBRID_SHA512_KDF ,Cipher: checksum, Blob: ecdhsharedk} 
