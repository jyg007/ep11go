...
// **********************************************************************************************************************
	...
	resp , err = ep11.AdminCommand(target,40, C.XCP_ADM_DOM_SET_ATTR,attrsBytes,[][]byte{privadmin1Bytes})        
        if err != nil {    
            fmt.Println(err)
        }
	fmt.Println()
...
// **********************************************************************************************************************
    ...
    // 1️⃣ Parse certificate (DER)
    cert, err := x509.ParseCertificate(cert1Bytes)
    if err != nil {
