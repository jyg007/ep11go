...
// **********************************************************************************************************************
	...
	signedmek1 , err := ep11.SignKeyPart(target,domain, encmek1,  skiBytes, privadmin1Bytes)
	signedmek2 , err := ep11.SignKeyPart(target,domain, encmek2,  skiBytes, privadmin1Bytes)
	signedmek3 , err := ep11.SignKeyPart(target,domain, encmek3,  skiBytes, privadmin1Bytes)
